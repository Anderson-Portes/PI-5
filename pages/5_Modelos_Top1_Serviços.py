...
with st.spinner():
    models = {
        'XGBOOST': xgb.get_model(data, True),
        'ARIMA': arima.get_model(data, True),
        'SARIMAX': sarimax.get_model(data, True),
        'PROPHET': proph.get_model(data, True)
    }
